...
const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-900 text-slate-200 dark:bg-slate-950">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-3 text-sm text-slate-300 max-w-xs">
              Enkonix Software Services builds secure, scalable software
              products — from product design to engineering and cloud
              operations.
            </p>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="https://github.com/Enkonix6465"
                target="_blank"
                rel="noreferrer"
                aria-label="GitHub"
                className="p-2 rounded-md bg-white/5 hover:bg-white/10"
